...
**그러나 우리는 이 분포를 학습하고 추론해 새로운 샘플을 만들기 위해서** $$\bm \theta$$**가** $$\bm \theta^*$$**에 가까워지록 최적화해야 한다.**

## 해결하려는 문제

$$\bm \theta$$를최적화하는 다양한 방법이 있지만 어떤 방법에도 다음 두 걸림돌이 생긴다. 두 근본적 문제를 효율적으로 해결할 방법을 찾으려 한다.
